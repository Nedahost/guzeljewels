...
"><!-- text sales start -->
        ...
        <div style="padding-bottom: 18px;font-size: 14px;text-decoration: underline;">
            <a href="<?php echo get_permalink(383); ?>">
                <b>Πως να βρείτε το ιδανικό μέγεθος για το δαχτυλίδι σας; </b>
            </a>
        </div>
        <?php } ?>
